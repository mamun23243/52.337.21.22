...
app.post(
  ...
  async (
    ...
    try {
      ...
      /*
       * IMPORTANT:
       * Do NOT spread parsed.data here.
       * parsed.data contains "password",
       * but Prisma User uses "passwordHash".
       */
      ...
      await prisma.activityLog.create({
        data: {
          ...
          action: "CREATE",
          description:
            `Created user ${u.username || u.email}`,
          ipAddress: ip(req),
          userAgent:
            req.headers["user-agent"]
        }
    ...
    try {
      ...
      await prisma.activityLog.create({
        data: {
          ...
          action: "UPDATE",
          description:
            `Updated user ${u.username || u.email}`,
          ipAddress: ip(req),
          userAgent:
            req.headers["user-agent"]
        }
    ...
    try {
      ...
      await prisma.activityLog.create({
        data: {
          ...
          action: "DELETE",
          description:
            `Deleted user ${u.username || u.email}`,
          ipAddress: ip(req),
          userAgent:
            req.headers["user-agent"]
        }
